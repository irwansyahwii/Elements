...
// in simulator we redefine to format for Elements Developer console
...
{\
	NSString * exceptionName = [@"org.elements." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.elements";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIElementsNativeItemNone = -1, 
	UIElementsNativeItemSpinner = -2,
	UIElementsNativeItemProgressBar = -3,
	
	UIElementsNativeItemSlider = -4,
	UIElementsNativeItemSwitch = -5,
	UIElementsNativeItemMultiButton = -6,
	UIElementsNativeItemSegmented = -7,
	
	UIElementsNativeItemTextView = -8,
	UIElementsNativeItemTextField = -9,
	UIElementsNativeItemSearchBar = -10,
	
	UIElementsNativeItemPicker = -11,
	UIElementsNativeItemDatePicker = -12,
	
	UIElementsNativeItemInfoLight = -13,
	UIElementsNativeItemInfoDark = -14,
	
	UIElementsNativeItemDisclosure = -15,
	
	UIElementsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Elements instances of
