...
//@interface ElementsObject : NSObject
//@end

@interface ElementsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ElementsObject class]])
		{
			for (NSString *key in [[(ElementsObject*)o modules] allKeys])
			{
